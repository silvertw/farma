# -*- coding: utf-8 -*-
#
# Farma documentation build configuration file, created by
# sphinx-quickstart on Tue Apr 26 14:03:55 2016.
#
...
html_title = u'Manual de Usuario'
...
# of the sidebar.
html_logo = '_static/logopequeno2.png'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/FPIcono.ico'
...
# the title page.
latex_logo = '_static/logopequeno2.png'
